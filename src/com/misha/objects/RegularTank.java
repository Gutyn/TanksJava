...
public class RegularTank extends JPanel implements Tank, EntityA {
	private static final long serialVersionUID = 1L;
	private volatile Image tankDown, tankUp, tankLeft, tankRight, imgTarget,
			field;
	...
	private volatile int tankX, tankY, coreX, coreY;
	private volatile Bullet tempBullet;
	private int barX, barY;
	private static String dir = "up";
	private volatile LinkedList<Bullet> list;
	RegularTank me = this;
	BlockingQueue<RegularTankRandom> tankList;
	private BlockingQueue<Image> imageList = new ArrayBlockingQueue<Image>(13);

	public RegularTank(BlockingQueue<RegularTankRandom> tankList) {
		barX = tankX;
		barY = tankY;
	...
	public void fire() {
		tempBullet = new Bullet(this.tankX, this.tankY, this, this, dir,
				tankList);
		list.add(tempBullet);
		tempBullet.fire();
	}
	...
	public void showRespown() {
		Object[] options = { "Yes, please", "No, thanks" };
		int n = JOptionPane.showOptionDialog(this, "Game Over. Start again?",
